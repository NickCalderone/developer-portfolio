...
<template>
	<section>
		...
		<div class="work-wrapper">
			...
			<Example class="example-1" imgSrc="covid.webp" alt="Pitkin county covid website"
				imgLink="https://covid19.pitkincounty.com" img-width="700" img-height="465" />
			<Example class="example-2" imgSrc="timberline.webp" alt="Timerline Construction website"
				imgLink="https://www.timberlineconstruct.com/" img-width="700" img-height="465"/>
			<Example class="example-3" imgSrc="emergency.webp" alt="Pitkin Emergency website"
