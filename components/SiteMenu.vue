		...
		<div class="header js-header js-header-top">
			<div class="header-inner">
				...
				<nav class="menu-wrapper">
					<ul class="menu">
						...
						<li class="menu-item">
							<a class="resume" href="/NickCalderone2025-12.pdf" target="_blank">
			...
			<nav class="mobile-menu-wrapper js-mobile-menu-wrapper">
				<ul class="mobile-menu">
					...
					<li class="mobile-menu-item">
						<a class="resume-mobile js-mobile-menu-focusable" tabindex="-1" href="/NickCalderone2025-12.pdf" target="_blank">
